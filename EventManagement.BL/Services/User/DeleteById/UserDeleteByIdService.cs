...
namespace EventManagement.BL.Services.User.DeleteById
{
    ...
    public class UserDeleteByIdService : IUserDeleteByIdService
    {
        private readonly MyDbContext dbContext;

        public UserDeleteByIdService(MyDbContext dbContext)
        {
        ...
        {
            var internalEventGetService = new InternalUserDeleteByIdService(dbContext);
        ...
        {
            var validate = new DeleteUserByIdValidator(dbContext);
